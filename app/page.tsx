      ...
      >
        ...
        >
          <div className={`container flex flex-col h-screen w-full relative justify-center items-center`}>
            ...
            <div className="isolate backdrop-blur-sm w-[90%] py-6 rounded-xl bg-black/30 shadow-lg ring-1 ring-black/5 outline outline-white absolute flex flex-col justify-start px-4 gap-2">
              ...
              <div className="flex flex-col justify-center items-center w-full -mb-6 mt-0">
                <div className="w-full flex flex-col sm:flex-row justify-start  sm:justify-between items-start sm:items-center py-2 my-4 gap-1">
                  <a
                    className="px-5 py-3 w-[90%] mx-auto sm:w-auto my-1 sm:my-0 rounded-lg text-blue-200 border-2 border-blue-200 bg-black/30 text-md sm:text-sm font-normal flex justify-center items-center"
                  ...
                  <a
                    className="px-6 py-3 w-[90%] mx-auto sm:w-auto my-1 sm:my-0 rounded-lg text-green-200 border-2 border-green-200 bg-black/30 text-md sm:text-sm font-normal flex justify-center items-center"
                  ...
                  <a
                    className="px-6 py-3 w-[90%] mx-auto sm:w-auto my-1 sm:my-0 rounded-lg text-orange-200 border-2 border-orange-200 bg-black/30 text-md sm:text-sm font-normal flex justify-center items-center"
